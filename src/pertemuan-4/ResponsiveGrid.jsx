    ...
    return (
        <div className="space-y-4 text-slate-700">
            <div className="space-y-1">
                <p>Coba lakukan zoom in atau zoom out. Perhatikan bahwa ukuran teks akan menyesuaikan dengan ukuran layar.</p>
                <p>Coba hapus class yang menggunakan prefix breakpoint (md:xxx, lg:xxx, xl:xxx) dan lihat perbedaannya!</p>
            </div>
